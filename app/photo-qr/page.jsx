  ...
  return (
    <div className="photo-qr-page" data-screen-label="Guest Photo QR Page">
      ...
      <section className="how" id="how">
        ...
        <div className="steps">
          <div className="step">
            <img className="shot" src="/images/guest-photo-qr-step-1-display-code.png" alt="A Capture the Love wedding photo QR card displayed on a candlelit reception table" width="1122" height="1402" loading="lazy" decoding="async" />
            <span className="num">01</span>
            <h4>Display your code</h4>
            <p>Your unique QR appears on table cards, signage and your invitation.</p>
          </div>
          <div className="step">
            <img className="shot" src="/images/guest-photo-qr-step-2-guests-scan.png" alt="A wedding guest scanning the table QR card with their phone camera" width="1136" height="1385" loading="lazy" decoding="async" />
            <span className="num">02</span>
            <h4>Guests scan it</h4>
            <p>A quick scan opens your upload page right in their browser—no app to install.</p>
          </div>
          <div className="step">
            <img className="shot" src="/images/guest-photo-qr-step-3-upload-photos.png" alt="A phone showing the photo selection screen ready to upload wedding photos to the shared gallery" width="1122" height="1402" loading="lazy" decoding="async" />
            <span className="num">03</span>
            <h4>They upload</h4>
            <p>Photos and videos upload straight from the camera roll in seconds.</p>
          </div>
          <div className="step">
            <img className="shot" src="/images/guest-photo-qr-step-4-collect-gallery.png" alt="A newlywed couple viewing their shared wedding photo gallery on a laptop" width="1122" height="1402" loading="lazy" decoding="async" />
